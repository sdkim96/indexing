...
func (n *NoopEnricher) Enrich(_ context.Context, _ string, _ []part.Part, _ cache.Cache) ([]search.SearchDoc, error) {
	return nil, nil
}
...
func (n *NoopSearchWriter) Write(_ context.Context, _ string, _ []search.SearchDoc) error {
	return nil
}
